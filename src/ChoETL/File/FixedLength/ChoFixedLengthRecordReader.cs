...
namespace ChoETL
{
    internal class ChoFixedLengthRecordReader : ChoRecordReader
    {
                        ...
                        && !_headerFound)
                    {
                        if (!_configCheckDone)
                        {
                            ...
                            else
                            {
                                ...
                                Configuration.ValidateInternal(headers == null ? pairElement : headers);
                            }
        ...
        private object ConvertToNestedObjectIfApplicable(object rec, bool headerLineFound)
        {
            ...
            return dict1.ConvertToNestedObject(Configuration.NestedKeySeparator == null ? '/' : Configuration.NestedKeySeparator.Value, Configuration.ArrayIndexSeparator,
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (pi != null)
                        {
                            ...
                            {
                                ChoType.SetPropertyValue(rec, fieldConfig.PIInternal, Convert.ChangeType(fieldValue, fieldConfig.FieldType, Configuration.Culture));
                            }
                            else
